...
Intel Core i3-14100T (14세대 Raptor Lake, TDP 35W) 기반 자체 조립 PC에 Unraid OS를 설치하여 가정용 NAS를 구축하는 것은 2025년 현재 가장 유연하고 확장 가능한 스토리지 솔루션입니다. **실제 하드웨어 스펙(i3-14100T, ASRock B760M Pro-A, DDR5 64GB, 3TB HDD 3개, SSD + NVMe)은 Unraid와 완벽하게 호환**되며, 적절히 구성하면 전력 소비 35-65W의 매우 효율적인 시스템을 구축할 수 있습니다. 이 가이드는 설치부터 보안 강화, 성능 최적화까지 가정용 NAS 구축에 필요한 모든 단계를 상세히 다룹니다.

Unraid는 기본적으로 보안 기능을 비활성화한 채로 출하되어 초기 설정을 쉽게 만들지만, 이는 곧 사용자가 직접 보안을 강화해야 함을 의미합니다. 3TB 드라이브 3개로 구성할 경우 **싱글 패리티로 6TB의 보호된 저장공간** 또는 **패리티 없이 9TB의 비보호 저장공간**을 확보할 수 있으며, XPG NVMe 1TB를 캐시로 활용하면 쓰기/읽기 속도가 대폭 향상됩니다. 본 가이드는 공식 Unraid 문서와 2024-2025년 커뮤니티 모범 사례를 기반으로 작성되었습니다.
...
**실제 구축 사양:**
- Intel Core i3-14100T (4코어/8스레드, TDP 35W)
